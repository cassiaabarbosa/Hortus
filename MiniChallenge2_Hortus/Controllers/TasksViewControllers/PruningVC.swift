...
class PruningVC : UITableViewController, UIPickerViewDelegate, UIPickerViewDataSource, UITextFieldDelegate, UINavigationControllerDelegate {
    ...
    func createTableView() {
        //frequencyArray.append(FrequencyInformation(frequencyLabel: "Período de rega", plantFrequency: "", picker: onepicker))
